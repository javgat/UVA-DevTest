...
func TestGetTeamsNilBD(t *testing.T) {
	...
	teams, err := GetTeams(nil, nil, nil, nil, nil)
	if err == nil {
...
func TestGetTeamsClosedBD(t *testing.T) {
	...
	db.Close()
	expectGetTeamsDefault(mock)
	teams, err := GetTeams(db, nil, nil, nil, nil)
	if err == nil {
		t.Log("error should not be nil", err)
		t.Fail()
	} else if teams != nil {
...
func TestGetTeamsUsernameNilDB(t *testing.T) {
	...
	teams, err := GetTeamsUsername(nil, username, nil, nil, nil, nil)
	if err == nil {
		t.Log("error should not be nil", err)
		t.Fail()
	} else if teams != nil {
...
func TestGetTeamsUsernameClosedDB(t *testing.T) {
	...
	db.Close()
	expectGetTeamsUsernameDefault(mock)
	teams, err := GetTeamsUsername(db, username, nil, nil, nil, nil)
	if err == nil {
		t.Log("error should not be nil", err)
		t.Fail()
	} else if teams != nil {
