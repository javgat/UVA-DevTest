...
func NewGetCorrectedAnswersFromPublishedTestsParams() GetCorrectedAnswersFromPublishedTestsParams {

	return GetCorrectedAnswersFromPublishedTestsParams{}
}

// GetCorrectedAnswersFromPublishedTestsParams contains all the bound params for the get corrected answers from published tests operation
// typically these are obtained from a http.Request
//
// swagger:parameters GetCorrectedAnswersFromPublishedTests
type GetCorrectedAnswersFromPublishedTestsParams struct {
...
//
// To ensure default values, the struct must have been initialized with NewGetCorrectedAnswersFromPublishedTestsParams() beforehand.
func (o *GetCorrectedAnswersFromPublishedTestsParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *GetCorrectedAnswersFromPublishedTestsParams) bindTestid(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
