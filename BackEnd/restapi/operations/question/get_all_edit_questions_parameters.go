...
// NewGetAllEditQuestionsParams creates a new GetAllEditQuestionsParams object
//
// There are no default values defined in the spec.
func NewGetAllEditQuestionsParams() GetAllEditQuestionsParams {

	return GetAllEditQuestionsParams{}
}

// GetAllEditQuestionsParams contains all the bound params for the get all edit questions operation
// typically these are obtained from a http.Request
//
// swagger:parameters GetAllEditQuestions
type GetAllEditQuestionsParams struct {
...
//
// To ensure default values, the struct must have been initialized with NewGetAllEditQuestionsParams() beforehand.
func (o *GetAllEditQuestionsParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *GetAllEditQuestionsParams) bindLikeTitle(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *GetAllEditQuestionsParams) bindLimit(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetAllEditQuestionsParams) validateLimit(formats strfmt.Registry) error {
...
func (o *GetAllEditQuestionsParams) bindOffset(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetAllEditQuestionsParams) validateOffset(formats strfmt.Registry) error {
...
func (o *GetAllEditQuestionsParams) bindOrderby(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetAllEditQuestionsParams) validateOrderby(formats strfmt.Registry) error {
...
func (o *GetAllEditQuestionsParams) bindTags(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var qvTags string
	if len(rawData) > 0 {
