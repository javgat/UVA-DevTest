...
func (o *AddAdminURL) Build() (*url.URL, error) {
	...
	if teamname != "" {
		...
		return nil, errors.New("teamname is required on AddAdminURL")
	}
	...
	if username != "" {
		...
		return nil, errors.New("username is required on AddAdminURL")
	}
...
func (o *AddAdminURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on AddAdminURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on AddAdminURL")
	}
