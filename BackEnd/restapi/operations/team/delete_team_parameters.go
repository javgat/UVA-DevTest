...
// DeleteTeamParams contains all the bound params for the delete team operation
...
type DeleteTeamParams struct {
	...
	/*Teamname of the team to delete
	  Required: true
	  In: path
	*/
	Teamname string
...
//
// To ensure default values, the struct must have been initialized with NewDeleteTeamParams() beforehand.
...
func (o *DeleteTeamParams) bindTeamname(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
