...
// NewGetTestsFromTeamParams creates a new GetTestsFromTeamParams object
//
// There are no default values defined in the spec.
func NewGetTestsFromTeamParams() GetTestsFromTeamParams {

	return GetTestsFromTeamParams{}
}

// GetTestsFromTeamParams contains all the bound params for the get tests from team operation
// typically these are obtained from a http.Request
//
// swagger:parameters GetTestsFromTeam
type GetTestsFromTeamParams struct {
	...
	*/
	Tags [][]string
	/*Teamname of the team to get its tests
	  Required: true
	  In: path
	*/
	Teamname string
...
//
// To ensure default values, the struct must have been initialized with NewGetTestsFromTeamParams() beforehand.
func (o *GetTestsFromTeamParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *GetTestsFromTeamParams) bindLikeTitle(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *GetTestsFromTeamParams) bindLimit(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetTestsFromTeamParams) validateLimit(formats strfmt.Registry) error {
...
func (o *GetTestsFromTeamParams) bindOffset(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetTestsFromTeamParams) validateOffset(formats strfmt.Registry) error {
...
func (o *GetTestsFromTeamParams) bindOrderby(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetTestsFromTeamParams) validateOrderby(formats strfmt.Registry) error {
...
func (o *GetTestsFromTeamParams) bindTags(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var qvTags string
	if len(rawData) > 0 {
...
func (o *GetTestsFromTeamParams) bindTeamname(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
