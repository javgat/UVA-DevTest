...
// NewGetPublicEditTestsParams creates a new GetPublicEditTestsParams object
//
// There are no default values defined in the spec.
func NewGetPublicEditTestsParams() GetPublicEditTestsParams {

	return GetPublicEditTestsParams{}
}

// GetPublicEditTestsParams contains all the bound params for the get public edit tests operation
// typically these are obtained from a http.Request
//
// swagger:parameters GetPublicEditTests
type GetPublicEditTestsParams struct {
...
//
// To ensure default values, the struct must have been initialized with NewGetPublicEditTestsParams() beforehand.
func (o *GetPublicEditTestsParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *GetPublicEditTestsParams) bindLikeTitle(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *GetPublicEditTestsParams) bindLimit(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetPublicEditTestsParams) validateLimit(formats strfmt.Registry) error {
...
func (o *GetPublicEditTestsParams) bindOffset(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetPublicEditTestsParams) validateOffset(formats strfmt.Registry) error {
...
func (o *GetPublicEditTestsParams) bindOrderby(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetPublicEditTestsParams) validateOrderby(formats strfmt.Registry) error {
...
func (o *GetPublicEditTestsParams) bindTags(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var qvTags string
	if len(rawData) > 0 {
