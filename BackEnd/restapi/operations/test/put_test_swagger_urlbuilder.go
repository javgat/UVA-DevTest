...
func (o *PutTestURL) Build() (*url.URL, error) {
	...
	if testid != "" {
		...
		return nil, errors.New("testid is required on PutTestURL")
	}
...
func (o *PutTestURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on PutTestURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on PutTestURL")
	}
