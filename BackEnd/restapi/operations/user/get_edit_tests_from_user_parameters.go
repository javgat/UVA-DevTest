...
// NewGetEditTestsFromUserParams creates a new GetEditTestsFromUserParams object
//
// There are no default values defined in the spec.
func NewGetEditTestsFromUserParams() GetEditTestsFromUserParams {

	return GetEditTestsFromUserParams{}
}

// GetEditTestsFromUserParams contains all the bound params for the get edit tests from user operation
// typically these are obtained from a http.Request
//
// swagger:parameters GetEditTestsFromUser
type GetEditTestsFromUserParams struct {
...
//
// To ensure default values, the struct must have been initialized with NewGetEditTestsFromUserParams() beforehand.
func (o *GetEditTestsFromUserParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *GetEditTestsFromUserParams) bindLikeTitle(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *GetEditTestsFromUserParams) bindLimit(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetEditTestsFromUserParams) validateLimit(formats strfmt.Registry) error {
...
func (o *GetEditTestsFromUserParams) bindOffset(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetEditTestsFromUserParams) validateOffset(formats strfmt.Registry) error {
...
func (o *GetEditTestsFromUserParams) bindOrderby(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetEditTestsFromUserParams) validateOrderby(formats strfmt.Registry) error {
...
func (o *GetEditTestsFromUserParams) bindTags(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var qvTags string
	if len(rawData) > 0 {
...
func (o *GetEditTestsFromUserParams) bindUsername(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
