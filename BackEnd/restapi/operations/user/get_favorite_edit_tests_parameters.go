...
// NewGetFavoriteEditTestsParams creates a new GetFavoriteEditTestsParams object
//
// There are no default values defined in the spec.
func NewGetFavoriteEditTestsParams() GetFavoriteEditTestsParams {

	return GetFavoriteEditTestsParams{}
}

// GetFavoriteEditTestsParams contains all the bound params for the get favorite edit tests operation
// typically these are obtained from a http.Request
//
// swagger:parameters GetFavoriteEditTests
type GetFavoriteEditTestsParams struct {
	...
	*/
	Tags [][]string
	/*Username of the user who favorited the tests
	  Required: true
	  In: path
	*/
	Username string
...
//
// To ensure default values, the struct must have been initialized with NewGetFavoriteEditTestsParams() beforehand.
func (o *GetFavoriteEditTestsParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *GetFavoriteEditTestsParams) bindLikeTitle(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *GetFavoriteEditTestsParams) bindLimit(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetFavoriteEditTestsParams) validateLimit(formats strfmt.Registry) error {
...
func (o *GetFavoriteEditTestsParams) bindOffset(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetFavoriteEditTestsParams) validateOffset(formats strfmt.Registry) error {
...
func (o *GetFavoriteEditTestsParams) bindOrderby(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetFavoriteEditTestsParams) validateOrderby(formats strfmt.Registry) error {
...
func (o *GetFavoriteEditTestsParams) bindTags(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var qvTags string
	if len(rawData) > 0 {
...
func (o *GetFavoriteEditTestsParams) bindUsername(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
