...
// NewGetFavoriteQuestionsParams creates a new GetFavoriteQuestionsParams object
//
// There are no default values defined in the spec.
func NewGetFavoriteQuestionsParams() GetFavoriteQuestionsParams {

	return GetFavoriteQuestionsParams{}
}

// GetFavoriteQuestionsParams contains all the bound params for the get favorite questions operation
// typically these are obtained from a http.Request
//
// swagger:parameters GetFavoriteQuestions
type GetFavoriteQuestionsParams struct {
...
//
// To ensure default values, the struct must have been initialized with NewGetFavoriteQuestionsParams() beforehand.
func (o *GetFavoriteQuestionsParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *GetFavoriteQuestionsParams) bindLikeTitle(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *GetFavoriteQuestionsParams) bindLimit(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetFavoriteQuestionsParams) validateLimit(formats strfmt.Registry) error {
...
func (o *GetFavoriteQuestionsParams) bindOffset(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetFavoriteQuestionsParams) validateOffset(formats strfmt.Registry) error {
...
func (o *GetFavoriteQuestionsParams) bindOrderby(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetFavoriteQuestionsParams) validateOrderby(formats strfmt.Registry) error {
...
func (o *GetFavoriteQuestionsParams) bindTags(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var qvTags string
	if len(rawData) > 0 {
...
func (o *GetFavoriteQuestionsParams) bindUsername(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
