...
// NewGetFavoriteTestsParams creates a new GetFavoriteTestsParams object
//
// There are no default values defined in the spec.
func NewGetFavoriteTestsParams() GetFavoriteTestsParams {

	return GetFavoriteTestsParams{}
}

// GetFavoriteTestsParams contains all the bound params for the get favorite tests operation
// typically these are obtained from a http.Request
//
// swagger:parameters GetFavoriteTests
type GetFavoriteTestsParams struct {
...
//
// To ensure default values, the struct must have been initialized with NewGetFavoriteTestsParams() beforehand.
func (o *GetFavoriteTestsParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *GetFavoriteTestsParams) bindLikeTitle(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *GetFavoriteTestsParams) bindLimit(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetFavoriteTestsParams) validateLimit(formats strfmt.Registry) error {
...
func (o *GetFavoriteTestsParams) bindOffset(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetFavoriteTestsParams) validateOffset(formats strfmt.Registry) error {
...
func (o *GetFavoriteTestsParams) bindOrderby(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetFavoriteTestsParams) validateOrderby(formats strfmt.Registry) error {
...
func (o *GetFavoriteTestsParams) bindTags(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var qvTags string
	if len(rawData) > 0 {
...
func (o *GetFavoriteTestsParams) bindUsername(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
