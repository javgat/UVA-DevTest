...
func (o *GetInvitedTestsByTeamsAndUserParams) bindLimit(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetInvitedTestsByTeamsAndUserParams) validateLimit(formats strfmt.Registry) error {
...
func (o *GetInvitedTestsByTeamsAndUserParams) bindOffset(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetInvitedTestsByTeamsAndUserParams) validateOffset(formats strfmt.Registry) error {
