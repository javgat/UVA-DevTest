...
func (o *GetPublishedTestsFromUserParams) bindLikeTitle(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *GetPublishedTestsFromUserParams) bindLimit(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetPublishedTestsFromUserParams) validateLimit(formats strfmt.Registry) error {
...
func (o *GetPublishedTestsFromUserParams) bindOffset(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetPublishedTestsFromUserParams) validateOffset(formats strfmt.Registry) error {
...
func (o *GetPublishedTestsFromUserParams) bindOrderby(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetPublishedTestsFromUserParams) validateOrderby(formats strfmt.Registry) error {
...
func (o *GetPublishedTestsFromUserParams) bindTags(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var qvTags string
	if len(rawData) > 0 {
