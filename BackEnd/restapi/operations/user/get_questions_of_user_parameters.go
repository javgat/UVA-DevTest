...
func (o *GetQuestionsOfUserParams) bindLimit(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetQuestionsOfUserParams) validateLimit(formats strfmt.Registry) error {
...
func (o *GetQuestionsOfUserParams) bindOffset(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetQuestionsOfUserParams) validateOffset(formats strfmt.Registry) error {
...
func (o *GetQuestionsOfUserParams) bindOrderby(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetQuestionsOfUserParams) validateOrderby(formats strfmt.Registry) error {
