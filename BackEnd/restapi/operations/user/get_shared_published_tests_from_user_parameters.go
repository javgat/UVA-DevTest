...
func (o *GetSharedPublishedTestsFromUserParams) bindLimit(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetSharedPublishedTestsFromUserParams) validateLimit(formats strfmt.Registry) error {
...
func (o *GetSharedPublishedTestsFromUserParams) bindOffset(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetSharedPublishedTestsFromUserParams) validateOffset(formats strfmt.Registry) error {
...
func (o *GetSharedPublishedTestsFromUserParams) bindOrderby(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetSharedPublishedTestsFromUserParams) validateOrderby(formats strfmt.Registry) error {
