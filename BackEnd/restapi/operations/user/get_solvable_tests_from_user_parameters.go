...
func (o *GetSolvableTestsFromUserParams) bindLimit(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetSolvableTestsFromUserParams) validateLimit(formats strfmt.Registry) error {
...
func (o *GetSolvableTestsFromUserParams) bindOffset(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetSolvableTestsFromUserParams) validateOffset(formats strfmt.Registry) error {
...
func (o *GetSolvableTestsFromUserParams) bindOrderby(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetSolvableTestsFromUserParams) validateOrderby(formats strfmt.Registry) error {
